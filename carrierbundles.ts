...
let network5gplus: Record<string,any> = {};
...
{
    return "27.0 and 27.2 beta 1";
}

doLocal('27.0-Rave24A437.V159OS')
await doOnline();
doLocal('27.2b1-RaveSeedUpdate24B5084k.V159DeveloperOS')
...
fs.writeFileSync(Path.join(__dirname, 'processed-5gplus.json'), JSON.stringify(network5gplus, null, 2));
